...
## AI
- [Qwen 3.8 Max 모델](./AI/260803_01_Qwen_3.8_Max_모델.md) - 2026.08.03
...
## DEVLOG
- [트랜잭션이 FCM 왕복을 감싸지 않게 하기 - outbox로 알림 보내기](./DEVLOG/트랜잭션이_FCM_왕복을_감싸지_않게_하기.md) - 2026.09.14
- [permitAll은 잘못된 토큰을 익명으로 보지 않는다 - 공개 API가 만료 토큰에 401을 내던 이유](./DEVLOG/permitAll은_잘못된_토큰을_익명으로_보지_않는다.md) - 2026.09.14
- [presigned URL 업로드 설계 - 왜 이 구조인가, 그리고 다음에 무엇을 할 것인가](./DEVLOG/presigned_URL_업로드_설계와_앞으로_해야_할_일.md) - 2026.09.04
- [리프레시 토큰 회전 설계 - 클러스터가 필요한가, 토큰에 무엇을 담을까](./DEVLOG/리프레시_토큰_회전_설계와_Redis_클러스터.md) - 2026.09.02
- [온보딩에서 찾은 인증 문제 두 가지 - 정지 계정과 Redis 클러스터 함정](./DEVLOG/온보딩에서_찾은_인증_문제_두_가지.md) - 2026.09.01
- [새로 합류한 프로젝트 - 셀프 온보딩](./DEVLOG/새로_합류한_프로젝트_셀프_온보딩.md) - 2026.09.01
- [파티셔닝을 실제 운영중인 서비스에 적용할 때 필요한 전략](./DEVLOG/파티셔닝을_실제_운영중인_서비스에_적용할_때_필요한_전략.md) - 2026.03.28
- [제한 시간 게임 중도 종료 유저 데이터 관리](./DEVLOG/제한_시간_게임_중도_종료_유저_데이터_관리.md) - 2026.03.27
- [대규모 트래픽 환경을 운영하는 e-commerce 시스템에서 Elasticsearch 활용 전략](./DEVLOG/E-commerce_시스템에서_Elasticsearch_활용_전략.md) - 2026.03.24
...
## System-Architecture
- [캐시를 활용하여 서비스 성능개선 전략과 실무 상황 예시](SYSTEM-ARCHITECTURE/260810_01_캐시를_활용하여_서비스_성능개선_전략과_실무_상황_예시.md) - 2026.08.10
- [Prometheus 메트릭을 노출만 하고 아무도 안 봤다 — 관측성 파이프라인의 4단계](SYSTEM-ARCHITECTURE/260806_01_Prometheus_메트릭을_노출만_하고_아무도_안_봤다_관측성_파이프라인의_4단계.md) - 2026.08.06
- ['배포 성공!!'을 출력하지만 컨테이너는 죽어 있었다 — 헬스체크 없는 배포의 함정](SYSTEM-ARCHITECTURE/260730_02_배포_성공을_출력하지만_컨테이너는_죽어있었다_헬스체크_없는_배포의_함정.md) - 2026.07.30
...
## TestCode
- [JUnit5](TESTCODE/260806_03_JUnit5.md) - 2026.08.06
- [테스트 프레임워크란](TESTCODE/260806_02_테스트_프레임워크란.md) - 2026.08.06
